This repository contains the sources to the meeting report.  A server located elsewhere automatically runs latex after every commit to this repository, and publishes the result at the following location:
