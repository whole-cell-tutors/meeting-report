...
Standard & SBGN support for hybrid maps containing Process Description, Entity Relationship, and Activity Flow nodes \\
\bottomrule
\end{tabularx}
\end{table*}
