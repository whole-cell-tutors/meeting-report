...
We organized the 2015 Whole-Cell Modeling Summer School to evaluate the need for new standards for whole-cell modeling, as well as to train students in whole-cell modeling. The majority of the school was focused on evaluating the ability of SBML to encode whole-cell models by trying to recode the the \textit{M. genitalium} whole-cell model using SBML. The ultimate goal of the school was to develop an open-source whole-cell model encoded in SBML and simulated using SED-ML.
...
The school was held March 9-13, 2015 at the University of Rostock in Rostock, Germany. The school was organized by Dagmar Waltemath and Falk Schreiber and supported by the Volkswagen Foundation.

\subsection{Educational outcomes}
\comment{Following the school, we surveyed the students to assess the educational outcome of the school.}{Karr}{What do the surveys actually say?}
...
In addition, many of the students reported that the school helped them network with other systems biologists. 
In particular, several students reported that the school introduced them to other systems biology opportunities including open postdoctoral positions and the 2016 Whole-Cell Modeling Summer School (\href{http://www.wholecell.org/school-2016}{http://www.wholecell.org/school-2016}).
...
Furthermore, we found that a high teacher to student ratio and a flexible schedule are necessary to successfully run open-ended project-based schools.
...
Lastly, we found that summer schools must have generous financial support. This enables organizers to accept students irrespective of their funding status. In turn, this enables the school to include a broader range of students than would otherwise be possible.


\section{Progress toward an SBML-encoded whole-cell model}
In addition to training young computational systems biology researchers, the second goal of the school was to recode the \textit{M. genitalium} whole-cell model using SBML. To achieve this goal, eight groups of four
