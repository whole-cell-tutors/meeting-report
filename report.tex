...
Several systems biology standards have already been developed by the the COmputational Modeling in BIology NEtwork (COMBINE)~\cite{le2011meeting} including the Systems Biology Markup Language (SBML)~\cite{hucka2003}, the Cell Markup Language (CellML)~\cite{hedley_2001b}, the Simulation Experiment Description Markup Language (SED-ML)~\cite{sedml2011}, and the System Biology Graphical Notation (SBGN)~\cite{IerselVCBBLDSDMFAMMKNS12}. SBML and CellML are standard languages for describing mathematical models including ODE, logical, and FBA models. Both have been used to build hundreds of models of various intracellular pathways. 
...
We organized the 2015 Whole-cell Modeling Summer School to train students in whole-cell modeling and to assess the limitations of the current systems biology standards for whole-cell modeling. 
The first and foremost goal of the course was to train young researchers how to build whole-cell models, including how to develop sub-models of individual cellular pathways using different mathematical formalisms; how to assemble sub-models into a single model; and how to encode models using SBML, simulate models using SED-ML, and visualize models using SBGN. 
The second goal of the course was to identify how the SBML, SED-ML, and SBGN languages must be expanded to support whole-cell models. 
The third goal of the course was to reimplement the \textit{M. genitalium} whole-cell model using SBML.
...
Second, we describe the educational outcome of the course and our progress toward encoding the \textit{M. genitalium} whole-cell model using SBML. 
