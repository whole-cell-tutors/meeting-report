...
SED-ML is a standard language for describing computational experiments. SED-ML enables computational scientists to reproduce simulations by tracking the parameter values used in each simulation. 
...
Taken together, further work is needed to expand the capabilities of our current systems biology standard languages SBML, CellML, SED-ML, and SBGN to support whole-cell modeling.
...
\comment{Following the summer school, we surveyed students to evaluate the course.}{Karr}{What did the survey results show?} 
Almost all of students reported that they gained a deep knowledge of whole-cell modeling. 
Most of the students also reported increased appreciation for the importance of reproducibility and increased understanding of the SBML, SED-ML, and SBGN standards and how they facilitate reproducible simulations.
