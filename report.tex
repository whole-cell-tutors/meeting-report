...
The main visualization problem encountered by the documentation group was that whole-cell models require large maps that must be manually arranged to produce intuitive diagrams.
...
We hope to finish encoding the \textit{M. genitalium} submodels in SBML and integrate the SBML-encoded submodels into a single model simulatable by open-source software tools such as COPASI, libRoadRunner, BioUML, and iBioSim. Several students and instructors have continued to keep working and meeting online. Several students and instructors also plan to participate in a second meeting in October 2015 that will be held at the University of Utah, USA immediately prior to the 2015 COMBINE Forum.
